          ...
          <v-row dense>
            <v-col md="6">
              ...
              <v-list-item>
                ...
                <v-list-item-subtitle>{{ filterCnpjCpf(cnpjCpf) || '-' }}</v-list-item-subtitle>
              </v-list-item>
            ...
            <v-row dense>
              <v-col md="6">
                <v-list-item>
                  ...
                  <v-list-item-subtitle>{{ filterIntToReal(valorPrincipal, true) }}</v-list-item-subtitle>
                </v-list-item>

                <v-list-item>
                  <v-list-item-title>Descontos</v-list-item-title>
                  <v-list-item-subtitle>{{ filterIntToReal(valorDescontos, true) || '-' }}</v-list-item-subtitle>
                </v-list-item>

                <v-list-item>
                  <v-list-item-title>Outras Dedu&ccedil;&otilde;es</v-list-item-title>
                  <v-list-item-subtitle>{{ filterIntToReal(valorOutrasDeducoes, true) || '-' }}</v-list-item-subtitle>
                </v-list-item>
              </v-col>
              <v-col md="6">
                <v-list-item>
                  <v-list-item-title>Multa</v-list-item-title>
                  <v-list-item-subtitle>{{ filterIntToReal(valorMulta, true) || '-' }}</v-list-item-subtitle>
                </v-list-item>

                <v-list-item>
                  <v-list-item-title>Juros</v-list-item-title>
                  <v-list-item-subtitle>{{ filterIntToReal(valorJuros, true) || '-' }}</v-list-item-subtitle>
                </v-list-item>

                <v-list-item>
                  <v-list-item-title>Outros Acr&eacute;scimos</v-list-item-title>
                  <v-list-item-subtitle>{{ filterIntToReal(valorOutrosAcrescimos, true) || '-' }}</v-list-item-subtitle>
                </v-list-item>
              </v-col>
            </v-row>
          </v-list-group>
